...
3. [LEFT JOIN](Concepts/LEFT%20JOIN.md) 
4. [RIGHT JOIN](Concepts/RIGHT%20JOIN.md) 
5. [CROSS JOIN](Concepts/CROSS%20JOIN.md) 
6.  [SELF JOIN](Concepts/SELF%20JOIN.md) 
7. [FULL OUTER JOIN (Conceptual in MySQL)](Concepts/FULL%20OUTER%20JOIN%20(Conceptual%20in%20MySQL).md)  - FULL JOIN 
8. [Join on Multiple Columns](Concepts/Join%20on%20Multiple%20Columns.md) 
9. [Join vs Subquery](Concepts/Join%20vs%20Subquery.md) 
10. [Join Questions](Concepts/Join%20Questions.md) 
## 10. Subqueries 
- Subquery in WHERE
- Subquery in SELECT
- Subquery in FROM
