...
- Problems with traditional Java (JDBC / Servlets)
...
- Monolithic vs Microservices (basic)
...
- @Autowired (Field vs Constructor injection)
...
## 7. Data Access Layer (JPA & Hibernate)
...
## 14. File Upload & Email

- Multipart file upload
    
- AWS S3 integration (basic)
